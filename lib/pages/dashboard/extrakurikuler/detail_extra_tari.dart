...
class DetailExtraTari extends StatefulWidget {
  const DetailExtraTari({super.key});

  @override
  State<DetailExtraTari> createState() => _DetailExtraTariState();
}

class _DetailExtraTariState extends State<DetailExtraTari> {
  @override
