import 'package:aplikasi_si/controller/wakil_kepala_controller.dart';
...
class _DetailWakilKepalaState extends State<DetailWakilKepala> {
  final WakilKepalaController _wakilKepalaController = WakilKepalaController();
  ...
  Future<Null> _initData() async{
    await _wakilKepalaController.loadData(withLoading: true);
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: onRefresh,
        child: Obx(() => _wakilKepalaController.isLoading.value ? Center(child: CircularProgressIndicator()) :
          ListView.builder(
            itemCount: _wakilKepalaController.wakilKepala.length,
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          _wakilKepalaController.wakilKepala[index].nama!,
                        ...
                        Text(
                          _wakilKepalaController.wakilKepala[index].jabatan!,
